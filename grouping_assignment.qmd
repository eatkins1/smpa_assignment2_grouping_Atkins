...
1.  Compare election types with recipient state

2.  Compare disbusment month to disburment amount

3.  Compare amendment indicator description to disbursment purpose category
